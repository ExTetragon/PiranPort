...
public class LablabBeanBlock extends CropBlock {
    ...
    public LablabBeanBlock (Properties properties){
        super (properties);
    }

    @Override
    public BlockState getPlant(BlockGetter world, BlockPos pos) {
        return ModBlocks.LABLAB_BEAN.get().defaultBlockState();
    }

    @Override
    protected ItemLike getBaseSeedId() {
        return ModItems.LABLAB_BEAN.get();
    }
